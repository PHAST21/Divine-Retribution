...
public class Rangedflying : MonoBehaviour
{
	...
	public void ApplyDamage(float damage)
	{
		if (!isInvincible)
		{
			...
			life -= damage;
			GetComponent<DmgTxtRangedFly>().dmgTextEnable();
...
/*	void DoDamage()
	...
	void DoDamage()
    {
		...
		throwableWeapon.GetComponent<FlyingBProjectile>().projectileDmg = dmgValue;
